...
export const SOZLUK: Record<string, { tr: string; en: string }> = {
  ...
  // şarkı yakala / av defteri
  "nav.avlarim": { tr: "avlarım", en: "my catches" },
  "av.baslik": { tr: "Av Defteri", en: "Catch Book" },
  "av.yakala": { tr: "şarkıyı yakala", en: "catch this song" },
  "av.yakalandi": { tr: "yakalandı", en: "caught" },
  "av.bos": { tr: "Henüz av yok. Hoşuna giden bir parça çalarken 🎣 düğmesine bas — buraya düşer.", en: "No catches yet. When a song you like is playing, tap 🎣 — it lands here." },
  "av.izle": { tr: "sanatçıyı izle", en: "watch artist" },
  "av.izleniyor": { tr: "izleniyor", en: "watching" },
  "av.izlemeBirak": { tr: "izlemeyi bırak", en: "stop watching" },
  "av.izlenenler": { tr: "izlenen sanatçılar", en: "watched artists" },
  "av.sil": { tr: "avı sil", en: "remove catch" },
  "av.temizle": { tr: "defteri temizle", en: "clear the book" },
  ...
  "kadran.simdiKadranda": { tr: "şu an kadranda", en: "now on the dial" },
